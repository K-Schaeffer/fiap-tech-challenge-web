...
- [Arquitetura do projeto](#arquitetura-do-projeto)
  - [Arquitetura Limpa do Dashboard App](#arquitetura-limpa-do-dashboard-app)
  ...
  - [Gerenciamento de autenticação no Root App](#gerenciamento-de-autenticação-no-root-app)
